...
<form:form modelAttribute="${refundForm}" name="refund_form" method="post" action="http://localhost:8080/resultRefund" >

    <label for="Status">RESULT:</label>
    <input name="status" type="text" id="status" value="${status}"><br><br>
